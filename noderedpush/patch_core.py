"""Core patching functionality for noderedpush plugin (blueprint registration)."""
...
def _project_dir():
    ...
    try:
        ...
        # Fallback: assume we're in src/plugins/noderedpush, go up 4 levels to project root
